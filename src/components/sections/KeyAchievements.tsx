...
const achievements = [
  ...
  },
  {
    ...
    tags: ["React Native", "Expo", "Firebase", "Razorpay", "JWT Auth", "App Store Connect"]
  },
  {
    id: "performance",
    title: "Performance & Backend Optimization",
    description: "Designed robust Laravel REST APIs with JWT authentication and optimized complex database queries. Improved Meilisearch indexing latency from 1200ms to 200ms—a 6× performance boost. Managed full release cycles via Google Play Console and App Store Connect.",
