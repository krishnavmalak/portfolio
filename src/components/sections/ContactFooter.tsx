...
export function ContactFooter() {
  ...
  return (
    <footer id="contact" className="pt-12 bg-background">
      ...
      <div className="bg-foreground py-16 text-muted-foreground dark:bg-slate-950">
        <div className="container px-4 mx-auto max-w-6xl flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="flex flex-col gap-2">
            <div className="text-2xl font-bold text-background dark:text-foreground tracking-tighter">krishna</div>
            <div className="text-sm text-muted-foreground">Building the future with mobile & AI-powered development</div>
          </div>
